...
plt.subplot(236), plt.imshow(edges, cmap='gray'), plt.title('Edge Image6')
...
plt.subplot(232), plt.imshow(edges5, cmap='gray'), plt.title('Edge Image')
